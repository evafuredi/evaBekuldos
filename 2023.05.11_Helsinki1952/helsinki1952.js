...
function Objectumfeltolto(feltoltendoElem) {
...
var helsinki = Objectumfeltolto(eredmenyek);
/*
...
function PontszerzoHelyekSzama(adatok) {
    return adatok.length;
}
function PontszerzoHelyekSzamaKiir(helyekSzama) {
...
//TUPLES KIIRATÓ
function ErmekSzamaKiir(eremMennyiseg) {
...
function SzerzetPontKiir(osszesPont) {
...
function TornaVsUszasKiir(gyakoribb) {
...
function LegtobbSportoloKiir(legnagyobb) {
